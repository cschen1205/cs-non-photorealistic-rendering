<html>
	<head>
		...
		<title>Non Photo-Realistic Rendering Application Web Portal: Home</title>
	...
	<body>
		<div id="page">
			...
			<td align="center" width="33%"><a href="photo_img_gallery.php">Photo Gallery Portal</a></td>
			</tr>
			</table>
			</div>
			<div id="container">
				<h1><a href="index.php">NPRender -- Home</a></h1>
				<h2>Web Portal for Uploaded Photos and Arts</h2>
...
for($index=0; $index < $indexCount; $index++) 
{
	...
	{ 
		...
		if(strcmp($ext, 'jpg')==0)
		{
			...
			print("<li>");
			print('<a class="thumb" name="leaf" href="create_photo_thumbnail.php?img='.$filename.'&mw=320&mh=480" title="Photo #'.$pageIndex.'">');
			...
			print('</div>');
			print('<div class="image-title">Photo #'.$pageIndex.'</div>');
...
for($index=0; $index < $indexCount; $index++) 
{
	...
	{ 
		...
		if(strcmp($ext, 'jpg')==0)
		{
			...
			print("<li>");
			print('<a class="thumb" name="leaf" href="create_art_thumbnail.php?img='.$filename.'&mw=320&mh=480" title="Img #'.$pageIndex.'">');
			print('<img src="create_art_thumbnail.php?img='.$filename.'&mw=80&mh=120" alt="Art #'.$pageIndex.'" />');
			print('</a>');
			print('<div class="caption">');
			print('<div class="download">');
			print('<a href="'.$fileurl.'">Download Original</a>');
			print('</div>');
			print('<div class="image-title">Art #'.$pageIndex.'</div>');
			print('<div class="image-desc">'.$filename.'</div>');
			print('</div>');
			print('</li>');
			$pageIndex++;
